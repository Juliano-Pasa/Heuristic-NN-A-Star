...
# Código para geração dos mapas de visibilidade
# Adaptado do algoritmo apresentado em: "Two Algorithms for Determining Partial Visibility and Reducing Data Structure Induced Error in Viewshed Analysis"
...
def is_visible(grid, o_i, o_j, t_i, t_j, cell_size):
    ...
    o_t_slope = calculate_slope(o_x, t_x, o_y, t_y, grid[o_i, o_j] +observer_height, grid[t_i, t_j])
